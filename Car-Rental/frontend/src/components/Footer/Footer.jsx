    ...
    <footer className={styles.container}>
      ...
      <div className={styles.innerContainer}>
          ...
          <div className={styles.brandSection}>
            <Link to="/" className="flex items-center">
              <div className={styles.logoContainer}>
                <img
                  src={logo}
                  alt="True_Drive_Rentalslogo"
                  className="h-[1em] w-auto block"
                  style={{ display: 'block', objectFit: 'contain' }}
                />
                <span className={styles.logoText}>True_Drive_Rentals</span>
              </div>
            </Link>
            <p className={styles.description}>
              “Experience luxury on the road with our latest premium cars and unmatched customer service. Book your dream ride today!”
            </p>
          ...
          <div>
            ...
            <ul className={styles.contactList}>
              <li className={styles.contactItem}>
                ...
                <span>2-A kamta Road , Lucknow</span>
              </li>
              <li className={styles.contactItem}>
        ...
        <div className={styles.copyright}>
          <p>© {new Date().getFullYear()} True_Drive_Rentals. All rights reserved.</p>
