...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/+917510002564?text=${whatsappMessage}`, '_blank');
        ...
        <div className={styles.cardContainer}>
            ...
            <div className="relative z-10 space-y-5">
              ...
              <div className={styles.infoItemContainer}>
                {[
                  ...
                  { icon: FaEnvelope, label: 'Email', value: 'prat27703@gmai.com', color: 'bg-orange-900/30' },
          ...
          <div className={styles.formCard}>
            ...
            <div className="mb-4">
              ...
              <p className={styles.formSubtitle}>“Send your inquiry and get a personal reply directly from the owner, Mr. Pratyush.”</p>
            </div>
